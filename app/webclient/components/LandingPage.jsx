    ...
    <p className="pull-right" style={{marginRight:"500px"}}>Blockchain Lab as a Service</p>
        ...
        return(
           ...
           >
            ...
            <FlatButton style={style.labelStyle1} label="Login" onTouchTap={this.loginNaviagtion} />
          <FlatButton style={style.labelStyle2} label="SignUp" onTouchTap={this.signUpNaviagtion} />
          <Drawer
              docked={false}
              width={200}
