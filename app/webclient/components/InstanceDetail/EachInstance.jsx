  ...
  state={
   ...
   onSiteChanged (evt) {
    ...
    start = ()=> {
      ...
      this.props.restartVM(requestObj);
      // Axios({
      //   method:'post',
      //   url:'http://laas-123.eastus.cloudapp.azure.com:8000/startVM',
      //   data:requestObj
      // })
      // .then((data) => {
      //      console.log(data)
    ...
    stop = ()=> {
      ...
      this.props.stopVM(requestObj);
      // Axios({
      //   method:'get',
      //   url:'http://laas-123.eastus.cloudapp.azure.com:8000/stopVM?cloudPlatform='+requestObj.cloud+"&vmName="+requestObj.instanceId,
      //   data:requestObj
      // })
      // .then((data) => {
      //      console.log(data)
...
{/*<td style={{textAlign:"center",paddingTop:"20px"}}>
   <input type="checkbox" name="site_name" 
            ...
            <td  style={{textAlign:"center",paddingTop:"20px"}}>
            <Link to={'/api/'+this.props.data.activeExp}>{this.props.data.activeExp} </Link></td>
        ...
        >
         Related Data will be shown Here
            ...
            >
              ...
              <tr>
               <th>Name</th>
               <td colSpan="2"> Create Accounts </td>
              </tr>
              <tr>
               <th>API</th>
               <td>{"http://"+this.props.data.vmIP+":3001/blockchain/v1/account/create"}</td>
               <td> <FlatButton label="Test" primary={true} /> </td>
              </tr>
              </table>
              <br/>
              <table style={{width:"100%"}}>
              <tr>
               <th>Name</th>
               <td colSpan="2"> Get All Accounts </td>
              </tr>
              <tr>
               <th>API</th>
              ...
              <tr>
               <th>Name</th>
               <td colSpan="2"> Send a transaction to an account </td>
              </tr>
              <tr>
               <th>API</th>
              ...
              <tr>
              <th>Params</th>
              <td colSpan="2"><pre>{JSON.stringify(params.sendTxnToAccnt, null, 2) }</pre></td>
              </tr>
              </table>
              <br/>
              <table style={{width:"100%"}}>
              <tr>
               <th>Name</th>
               <td colSpan="2"> Get Transaction Details </td>
              </tr>
              <tr>
               <th>API</th>
              ...
              <tr>
               <th>Name</th>
               <td colSpan="2"> Create Contract </td>
              </tr>
              <tr>
               <th>API</th>
              ...
              <tr>
              <th>Params</th>
              <td colSpan="2"><pre>{JSON.stringify(params.createContract, null, 2) }</pre></td>
              </tr>
              </table>
              <br/>
              <table style={{width:"100%"}}>
              <tr>
               <th>Name</th>
               <td colSpan="2"> Send a transaction to a contract </td>
              </tr>
              <tr>
               <th>API</th>
              ...
              <tr>
              <th>Params</th>
              <td colSpan="2"><pre>{JSON.stringify(params.sendTxnToContract, null, 2) }</pre></td>
              </tr>
              </table>
              <br/>
              </div>
