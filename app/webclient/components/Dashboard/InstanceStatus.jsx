    ...
    render(){
        return(
            <div >
                ...
                <Col xs={6}  style={{width:"200px",marginLeft:"20px", borderRadius: "6px",
    border: "solid 1px #d5d5d5",height:"100px",
    marginBottom:"5px",}}>
                <Link to='instanceInfo'><h3 style={{color:'rgb(0, 188, 212)'}}>Running:{' '}{' '}{this.props.running}</h3></Link>                 
                <CircularProgress color="yellow"/>
                </Col>
                <Col xs={6} style={{width:"200px",marginLeft:"20px", borderRadius: "6px",
    border: "solid 1px #d5d5d5",height:"100px",
    marginBottom:"5px"}}>
                <h3>Stopped {' '}: {' '}{this.props.stopped}</h3>
                <br />
